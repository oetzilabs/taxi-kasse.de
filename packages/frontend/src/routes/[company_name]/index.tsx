...
export default function CompanyPage() {
  ...
  return (
    <div class="container h-[calc(100dvh-50px)] mx-auto flex flex-col gap-2 px-2">
      <Show when={data() && data()} fallback={<div class="flex justify-center items-center p-10">Loading...</div>}>
        {(d) => (
          <div class="w-full h-auto flex-col relative justify-start items-start inline-flex">
            <div class="w-full flex flex-col bg-white dark:bg-black z-50 sticky top-[49px]">
              ...
              <div class="self-stretch py-5 justify-between items-center inline-flex">
                ...
                <div class="justify-start items-center gap-2.5 flex">
                  ...
                  >
                    ...
                    <div class=" text-base font-bold">Share</div>
                  </button>
                  <button
                  ...
                  >
                    ...
                    <div class="text-base font-bold">Reports</div>
                  </button>
                </div>
              </div>
            </div>
            <div class="flex w-full flex-grow relative bg-black/[0.02] rounded-sm border border-black dark:border-white dark:bg-white/[0.02] !border-opacity-10 overflow-clip">
              ...
              <Show when={(d().company.data.months[cuMonth()]?.entries.length ?? 0) > 0}>
                <table class="border-collapse relative w-full table-fixed">
                  <thead class="bg-white dark:bg-neutral-950 border-b border-black/10 dark:border-white/10 overflow-y-auto">
                    <tr>
