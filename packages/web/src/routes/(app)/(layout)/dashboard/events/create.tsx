...
export const route = {
  preload: async () => {
    ...
    return { session, language, regions };
  },
...
export default function CreateEvent() {
  ...
  const [form, setForm] = createStore<InferInput<typeof Events.Create>>({
    name: "",
    description: "",
    region_id: null,
    origin_id: null,
  ...
  const createEventAction = useAction(createEvent);
  const createEventSubmission = useSubmission(createEvent);
    ...
    <div class="flex flex-col gap-4 w-full">
      ...
      <div class="flex flex-col gap-4 w-full">
        ...
        <div class="flex flex-row items-center gap-4 justify-end">
          <Button
            disabled={!form.name || !form.description || !form.date || createEventSubmission.pending}
            size="sm"
            onClick={() => {
