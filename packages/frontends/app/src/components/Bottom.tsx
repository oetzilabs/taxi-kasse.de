...
export type BottomVariants = typeof BottomVariants;

export const [bottomVariant, setBottomVariant] = createSignal<BottomVariants[keyof BottomVariants]>("default");
...
export const Bottom = (props: { queryClient: QueryClient; buildVersion: string }) => {
  ...
  return (
    ...
    >
      <Switch>
        <Match when={bottomVariant() === BottomVariants.MAP}>
          <div></div>
        </Match>
        <Match when={bottomVariant() === BottomVariants.DEFAULT}>
          <div
